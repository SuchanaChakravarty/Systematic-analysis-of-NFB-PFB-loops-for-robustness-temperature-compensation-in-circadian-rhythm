...
for i=1:7
    i
    Temp(i,1)=278+5*i;
[t,c]=ode45(@(t,c) subdep(t,c,Temp(i,1),Ae_k1(q,1),...
    Ae_k2(q,1),Ae_k3(q,1),Ae_k4(q,1)) ,tspan,css);
% figure(2)
...
save -ascii subdep_period.dat period1
save -ascii Tot_Rate_Var_selkov.dat Tot_Rate_Var_val
%%
