...
k1 = Ae_k1.*exp(-(21.5.*10^3)/(8.3144598.*Temp)); % 0.0691 (Large k3 Small k5)
k2 = Ae_k2.*exp(-(27.5.*10^3)/(8.3144598.*Temp)); % 0.0058 
k3 = Ae_k3.*exp(-(5.17*10^3)/(8.3144598.*Temp)); % 47.6363 (Large k3)
k4 = Ae_k4.*exp(-(14.8691.*10^3)/(8.3144598.*Temp)); % 0.9503 
k5 =Ae_k5.*exp(-(12.0203*10^3)/(8.3144598.*Temp)); % 3 (Small k5);

% parameter as base value at each temperature, pre-exponential factor
% =Ae=383.83
k1p = 383.83.*exp(-(21.5.*10^3)/(8.3144598.*Temp)); % 0.0691 (Large k3 Small k5)
k2p = 383.83.*exp(-(27.5.*10^3)/(8.3144598.*Temp)); % 0.0058 
k3p = 383.83.*exp(-(5.17*10^3)/(8.3144598.*Temp)); % 47.6363 (Large k3)
k4p = 383.83.*exp(-(14.8691.*10^3)/(8.3144598.*Temp)); % 0.9503 
k5p =383.83.*exp(-(12.0203*10^3)/(8.3144598.*Temp)); % 3 (Small k5);
