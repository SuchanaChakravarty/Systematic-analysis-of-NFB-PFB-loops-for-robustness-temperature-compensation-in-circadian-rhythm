load Luca_osc_period.dat; % get that value after the simulation from Arithmatic-Mean folder
load Luca_osc_period_avg.dat; % get that value after the simulation from Time-Course folder
A = Luca_osc_period;
B = Luca_osc_period_avg;
C = zeros(7,100);
