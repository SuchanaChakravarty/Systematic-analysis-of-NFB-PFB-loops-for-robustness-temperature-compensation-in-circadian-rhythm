load small_NFL_period.dat; % get that value after the simulation from Arithmatic-Mean folder
load NFL_period_avg.dat; % get that value after the simulation from Time-Course folder
A = small_NFL_period;
B = NFL_period_avg;
C = zeros(7,100);
