load Rust_period.dat; % get that value after the simulation from Arithmatic-Mean folder
load Rust_period_avg.dat; % get that value after the simulation from Time-Course folder
A = Rust_period;
B = Rust_period_avg;
C = zeros(7,100);
